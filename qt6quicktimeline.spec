...
Version  : 6.8.0
Release  : 22
URL      : https://download.qt.io/official_releases/qt/6.8/6.8.0/submodules/qtquicktimeline-everywhere-src-6.8.0.zip
Source0  : https://download.qt.io/official_releases/qt/6.8/6.8.0/submodules/qtquicktimeline-everywhere-src-6.8.0.zip
...
%prep
%setup -q -n qtquicktimeline-everywhere-src-6.8.0
cd %{_builddir}/qtquicktimeline-everywhere-src-6.8.0
pushd ..
cp -a qtquicktimeline-everywhere-src-6.8.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732611153
mkdir -p clr-build
pushd clr-build
...
%files dev
%defattr(-,root,root,-)
/usr/include/QtQuickTimeline/6.8.0/QtQuickTimeline/private/qquickkeyframe_p.h
/usr/include/QtQuickTimeline/6.8.0/QtQuickTimeline/private/qquickkeyframedatautils_p.h
/usr/include/QtQuickTimeline/6.8.0/QtQuickTimeline/private/qquicktimeline_p.h
/usr/include/QtQuickTimeline/6.8.0/QtQuickTimeline/private/qquicktimelineanimation_p.h
/usr/include/QtQuickTimeline/6.8.0/QtQuickTimeline/private/qtquicktimelineglobal_p.h
...
/usr/include/QtQuickTimelineBlendTrees/6.8.0/QtQuickTimelineBlendTrees/private/qblendanimationnode_p.h
/usr/include/QtQuickTimelineBlendTrees/6.8.0/QtQuickTimelineBlendTrees/private/qblendtreenode_p.h
/usr/include/QtQuickTimelineBlendTrees/6.8.0/QtQuickTimelineBlendTrees/private/qtimelineanimationnode_p.h
/usr/include/QtQuickTimelineBlendTrees/6.8.0/QtQuickTimelineBlendTrees/private/qtquicktimelineblendtreesglobal_p.h
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libQt6QuickTimeline.so.6.8.0
/V3/usr/lib64/libQt6QuickTimelineBlendTrees.so.6.8.0
...
/usr/lib64/libQt6QuickTimeline.so.6.8.0
/usr/lib64/libQt6QuickTimelineBlendTrees.so.6
/usr/lib64/libQt6QuickTimelineBlendTrees.so.6.8.0
