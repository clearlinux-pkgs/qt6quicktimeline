...
Source0  : https://download.qt.io/official_releases/qt/6.8/6.8.2/submodules/qtquicktimeline-everywhere-src-6.8.2.zip
...
%prep
%setup -q -n qtquicktimeline-everywhere-src-6.8.2
cd %{_builddir}/qtquicktimeline-everywhere-src-6.8.2
pushd ..
cp -a qtquicktimeline-everywhere-src-6.8.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738706054
mkdir -p clr-build
pushd clr-build
...
%files dev
%defattr(-,root,root,-)
/usr/include/QtQuickTimeline/6.8.2/QtQuickTimeline/private/qquickkeyframe_p.h
/usr/include/QtQuickTimeline/6.8.2/QtQuickTimeline/private/qquickkeyframedatautils_p.h
/usr/include/QtQuickTimeline/6.8.2/QtQuickTimeline/private/qquicktimeline_p.h
/usr/include/QtQuickTimeline/6.8.2/QtQuickTimeline/private/qquicktimelineanimation_p.h
/usr/include/QtQuickTimeline/6.8.2/QtQuickTimeline/private/qtquicktimelineglobal_p.h
...
/usr/include/QtQuickTimelineBlendTrees/6.8.2/QtQuickTimelineBlendTrees/private/qblendanimationnode_p.h
/usr/include/QtQuickTimelineBlendTrees/6.8.2/QtQuickTimelineBlendTrees/private/qblendtreenode_p.h
/usr/include/QtQuickTimelineBlendTrees/6.8.2/QtQuickTimelineBlendTrees/private/qtimelineanimationnode_p.h
/usr/include/QtQuickTimelineBlendTrees/6.8.2/QtQuickTimelineBlendTrees/private/qtquicktimelineblendtreesglobal_p.h
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libQt6QuickTimeline.so.6.8.2
/V3/usr/lib64/libQt6QuickTimelineBlendTrees.so.6.8.2
...
/usr/lib64/libQt6QuickTimeline.so.6.8.2
/usr/lib64/libQt6QuickTimelineBlendTrees.so.6
/usr/lib64/libQt6QuickTimelineBlendTrees.so.6.8.2
...
/usr/lib64/qt6/sbom/qtquicktimeline-6.8.2.spdx
